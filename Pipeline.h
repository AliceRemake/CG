...
// const glm::mat4 vertex_matrix = V * Transformer::Model();
    //
    ...
    // const glm::mat4 vertex_matrix = V * Transformer::Model(model);
    ...
    //   glm::vec4 position = V * glm::vec4(scene.lights[i].position, 1.0f);
